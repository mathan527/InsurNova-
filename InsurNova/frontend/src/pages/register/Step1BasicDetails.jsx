...
export default function Step1BasicDetails({ formData, updateFormData, nextStep }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // FIX: was hitting localhost:3000/api/auth/register-step1 (wrong port, non-existent endpoint)
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0095B6] text-gray-900 placeholder-gray-400"
