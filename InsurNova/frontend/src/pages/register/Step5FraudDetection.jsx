...
export default function Step5FraudDetection({ formData, updateFormData, nextStep, prevStep }) {
  ...
  const runFraudCheck = async () => {
    setLoading(true);
    // /api/fraud/check endpoint doesn't exist — run client-side detection directly
      ...
      <div className="bg-white/90 rounded-lg p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white border border-gray-200 p-4 rounded-lg">
            <div className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Fraud Score</div>
            <div className={`text-3xl font-bold ${
              fraudCheck.fraudScore < 25 ? 'text-green-700' : 
              fraudCheck.fraudScore < 50 ? 'text-yellow-700' : 'text-red-700'
            }`}>
          ...
          <div className="bg-white border border-gray-200 p-4 rounded-lg">
            <div className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Trust Score</div>
        ...
        {/* Flags */}
        <div className="bg-white border border-gray-200 p-4 rounded-lg">
          <div className="font-bold text-gray-900 mb-3">Detection Results</div>
