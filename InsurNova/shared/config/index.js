...
const config = {
  ...
  supabase: {
    ...
    // Accepts SUPABASE_SERVICE_ROLE_KEY (correct JWT, starts with eyJ...) or legacy SUPABASE_SERVICE_KEY
...
const validateConfig = () => {
  const required = ['supabase.url', 'supabase.serviceKey', 'supabase.anonKey'];
  const missing = [];
